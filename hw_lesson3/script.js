...
//прикольний спосіб, але неочевидний. Ліпше зробити через arr = Array(100500) або ж arr.length = 100500
...
//функція не повертає значення (має повертатись значення через return)
...
//Твоя функція не повертає масив, а лише перевіряє, чи парне значення
